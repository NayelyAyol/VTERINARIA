...
// Importar los hooks para conectar con backend
...
const Login = () => {
    ...
    // Luego se asocia el register con el campo de error, en cada input ya que estamos usando useForm
        ...
        <div className="flex flex-col sm:flex-row h-screen">
            ...
            <div className="w-full sm:w-1/2 flex justify-center items-center bg-white">
                ...
                <div className="w-4/5">
                    ...
                    {/* Formulario */}
                    <form onSubmit={handleSubmit(loginUser)}> {/* Se asocia el método con loginUser */}
