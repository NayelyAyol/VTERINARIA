        ...
        <ToastContainer />
            ...
            <form onSubmit={handleSubmit(updatePassword)}>
                ...
                <div>
                    ...
                    />
                    {errors.passwordactual && <span className="text-red-500">La contraseña actual es obligatoria</span>}
                </div>
                ...
                <div>
                    ...
                    />
                    {errors.passwordnuevo && <span className="text-red-500">La nueva contraseña es obligatoria</span>}
                </div>
